...
Enter the marks of student: 12
Enter the marks of student: 61
Enter the marks of student: 23
Enter the marks of student: 35
Given array is
12 61 23 35 
Sorted array is: 
12 23 35 61 
...
def binarySearch (array, x, low, high):
    ...
    while low < high :
        ...
        if array[mid] > x :
            ...
            high = mid
    return index
array = [int(item) for item in input("Enter the numbers of list: ").split()]
x = int(input("Enter the number to search for repeatition"))
new=sorted(array)
...
if result != -1 : #If element is found
    ...
    print( "Not found" )
Enter the numbers of list: 5 6 9 19 36 78 4 9 6 13 0 12 4 9 6 78 6 34 35 56 9 4
Enter the number to search for repeatition4
Sorted Array is, [0, 4, 4, 4, 5, 6, 6, 6, 6, 9, 9, 9, 9, 12, 13, 19, 34, 35, 36, 56, 78, 78]
Number of occurences of element 4 is: 3
